    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('operator', 'Operator'), ('manager', 'Manager'), ('seller', 'Seller'), ('user', 'User')], default='user', max_length=50)),
                ('phone_number', models.CharField(db_column='user_phone_number', max_length=12, unique=True)),
